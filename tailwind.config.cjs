...
// rgba(255, 99, 71, 1), rgba(23, 22, 31, 1)
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        about:
          'linear-gradient(165deg, rgba(23,22,31,1) 100%, rgba(122,122,122,1) 100%)',
        experience:
          'linear-gradient(180deg, rgba(255,255,255,1) 25%, rgba(23,22,31,1) 100%)',
        // experienceLight:
